...
--
-- Table structure for table `tbl_service_category_price`
--

CREATE TABLE `tbl_service_category_price` (
  `id` int(255) NOT NULL,
  `service_id` int(255) NOT NULL,
  `category_id` int(255) NOT NULL,
...
--
-- Dumping data for table `tbl_service_category_price`
--

INSERT INTO `tbl_service_category_price` (`id`, `service_id`, `category_id`, `price`) VALUES
(1, 1, 1, 35.00),
(2, 1, 2, 55.00),
(3, 1, 3, 65.00),
(4, 2, 1, 80.00),
...
--
-- Table structure for table `tbl_service_option_price`
--

CREATE TABLE `tbl_service_option_price` (
...
--
-- Dumping data for table `tbl_service_option_price`
--

INSERT INTO `tbl_service_option_price` (`option_price_id`, `option_id`, `service_option_type`, `price`) VALUES
(1, 1, 'Delivery', 50.00),
(2, 2, 'Pick up', 25.00),
(7, 3, 'Rush', 25.00);
...
--
-- Dumping data for table `tbl_settings_config`
--

INSERT INTO `tbl_settings_config` (`settings_id`, `min_kilos`, `max_kilos`, `delivery_day`) VALUES
(1, 5, 20, 3);
...
INSERT INTO `tbl_users` (`user_id`, `username`, `first_name`, `last_name`, `password`, `profile_picture`, `role`, `user_status`, `date_created`) VALUES
...
--
-- Indexes for table `tbl_service_category_price`
--
ALTER TABLE `tbl_service_category_price`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `tbl_service_option_price`
--
ALTER TABLE `tbl_service_option_price`
...
--
-- AUTO_INCREMENT for table `tbl_service_category_price`
--
ALTER TABLE `tbl_service_category_price`
...
--
-- AUTO_INCREMENT for table `tbl_service_option_price`
--
ALTER TABLE `tbl_service_option_price`
...
--
-- Constraints for table `tbl_service_category_price`
--
ALTER TABLE `tbl_service_category_price`
  ADD CONSTRAINT `tbl_service_category_price_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `tbl_category` (`category_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_service_category_price_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `tbl_service` (`service_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tbl_service_option_price`
--
ALTER TABLE `tbl_service_option_price`
  ADD CONSTRAINT `tbl_service_option_price_ibfk_1` FOREIGN KEY (`option_id`) REFERENCES `tbl_service_options` (`option_id`) ON DELETE CASCADE ON UPDATE CASCADE;
