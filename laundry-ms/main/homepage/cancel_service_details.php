...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sqlGetServiceRequests = "SELECT request_id FROM tbl_service_request WHERE customer_id =? AND order_status = 'active'";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $sqlCancelServiceRequest = "UPDATE tbl_service_request SET order_status = 'cancelled' WHERE request_id =?";
