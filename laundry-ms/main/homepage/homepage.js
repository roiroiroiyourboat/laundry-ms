...
$('#service, #category').change(function() {
    ...
    if (serviceId && categoryId) {
      $.ajax({
        type: 'GET',
        url: '/laundry-ms/main/homepage/home_configs/getPrice.php',
...
$('#service_option').change(function() {
    ...
    if (serviceOptionId) {
      $.ajax({
        type: 'GET',
        url: '/laundry-ms/main/homepage/home_configs/getServiceOptionRate.php',
...
$('#rush').change(function() {
    if ($(this).is(':checked')) {
        $.ajax({
            type: 'GET',
            url: '/laundry-ms/main/homepage/home_configs/getRushFee.php',
            data: {rush: 'Rush'},
            dataType: 'json'
        })
        .done(function(data) {
...
$(document).ready(function() {
    ...
    $('#form_id').submit(function(event) {
        ...
        $.ajax({
            type: 'GET',
            url: '/laundry-ms/main/homepage/home_configs/weight_limits.php',
